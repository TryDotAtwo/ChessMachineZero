...
export const TRACE: TraceStage[] = [
  { id: 0, short: "SRC", title: "Источник", equation: "H(QKᵀ)V", detail: "Каждый из 256 candidate-токенов забирает фигуру со своей исходной клетки.", activeTokens: ["SQUARE:e2=WP", "CANDIDATE:e2→e4"] },
  ...
  { id: 6, short: "P₂", title: "Допустимая цель", equation: "P₂=lookup(target,side,kind)", detail: "Push требует EMPTY, capture — фигуру противоположного цвета. Решение выдаёт relation-токен TARGET_ALLOWED.", activeTokens: ["TARGET=BLACK_PIECE", "SIDE=WHITE", "KIND=CAPTURE", "TARGET_ALLOWED=true"] },
  ...
  { id: 9, short: "SEL", title: "Выбор хода", equation: "one_hot(argmax(LEGAL))", detail: "Детерминированный hardmax выбирает минимальный индекс среди legal-кандидатов.", activeTokens: ["256 candidates", "winner:e2→e3"] },
...
export const TOKEN_ROWS = [
  ...
  { token: "TARGET_ALLOWED", value: "TRUE", role: "предикат" },
