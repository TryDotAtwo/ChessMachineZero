...
- site_matrix_inspector=RU/EN transformer-style grids cover all 45 operations; output-cell selection drives exact row/column highlighting and arithmetic provenance, while semantic labels are primary and `vN/wN` remain secondary SSA identifiers
